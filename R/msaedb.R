...
#' @description This function produces EBLUPs, MSE, and Aggregarion of Multivariat SAE with Difference Benchmarking
...
#' msaeDB <- msaedb(formula, vardir, weight)
#'
...
msaedb <- function (formula, vardir, weight, samevar = FALSE, MAXITER = 100, PRECISION = 1e-04,
  ...
  result = list(MSAE_Eblup = NA, MSE_Eblup = NA,
  ...
  result$MSAE_Eblup = signif(MSAE_Eblup, digits = 5)
